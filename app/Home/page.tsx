        ...
        <div className="bg-[#0E191F] p-4 rounded-lg text-white">
          ...
          {isEditAbout ? (
            ...
            <div className="mt-2 space-y-1 text-sm">
              ...
              <p>
                <span className="text-gray-400">Zodiac:</span> {profile.zodiac}
              </p>
              <p>
                <span className="text-gray-400">Height:</span> {profile.height}
              </p>
              <p>
                <span className="text-gray-400">Weight:</span> {profile.weight}
              </p>
            </div>
          )}
        </div>
